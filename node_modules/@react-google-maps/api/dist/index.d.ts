...
import react__default, { ReactNode, CSSProperties, PureComponent, RefObject, ReactElement, ReactPortal, ReactChild } from 'react';
...
declare class ClustererComponent extends PureComponent<ClustererProps, ClustererState> {
    static contextType: react.Context<google.maps.Map | null>;
    registeredEvents: google.maps.MapsEventListener[];
 ...
 */
declare function GoogleMarkerClusterer({ children, options }: GoogleMarkerClustererProps): react__default.ReactElement<any, any> | null;
declare const _default: react__default.MemoExoticComponent<typeof GoogleMarkerClusterer>;
...
declare class InfoWindow extends react.PureComponent<InfoWindowProps, InfoWindowState> {
    static contextType: react.Context<google.maps.Map | null>;
    registeredEvents: google.maps.MapsEventListener[];
    containerElement: HTMLElement | null;
...
declare class Polygon extends PureComponent<PolygonProps, PolygonState> {
    static contextType: react.Context<google.maps.Map | null>;
    registeredEvents: google.maps.MapsEventListener[];
    state: PolygonState;
...
declare class Data extends react.PureComponent<DataProps, DataState> {
    static contextType: react.Context<google.maps.Map | null>;
    registeredEvents: google.maps.MapsEventListener[];
    state: DataState;
...
declare class OverlayView extends react.PureComponent<OverlayViewProps, OverlayViewState> {
...
declare class DirectionsService extends react.PureComponent<DirectionsServiceProps, DirectionsServiceState> {
...
declare class DistanceMatrixService extends react.PureComponent<DistanceMatrixServiceProps, DistanceMatrixServiceState> {
...
export { Autocomplete, AutocompleteProps, BicyclingLayer, BicyclingLayerProps, Circle, CircleProps, Data, DataProps, DirectionsRenderer, DirectionsRendererProps, DirectionsService, DirectionsServiceProps, DistanceMatrixService, DistanceMatrixServiceProps, DrawingManager, DrawingManagerProps, GoogleMap, GoogleMapProps, _default as GoogleMarkerClusterer, GoogleMarkerClustererProps, GroundOverlay, GroundOverlayProps, HeatmapLayer, HeatmapLayerProps, InfoBoxComponent as InfoBox, InfoBoxProps, InfoWindow, InfoWindowProps, KmlLayer, KmlLayerProps, LoadScript, _default$1 as LoadScriptNext, LoadScriptNextProps, LoadScriptProps, MapContext, Marker, ClustererComponent as MarkerClusterer, ClustererProps as MarkerClustererProps, MarkerProps, OverlayView, OverlayViewProps, Polygon, PolygonProps, Polyline, PolylineProps, Rectangle, RectangleProps, StandaloneSearchBox, StandaloneSearchBoxProps, StreetViewPanorama, StreetViewPanoramaProps, StreetViewService, StreetViewServiceProps, TrafficLayer, TrafficLayerProps, TransitLayer, TransitLayerProps, useGoogleMap, useJsApiLoader, useLoadScript };
