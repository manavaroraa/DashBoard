...
class InfoWindow extends React__namespace.PureComponent {
    ...
    render() {
        return this.containerElement ? (ReactDOM__namespace.createPortal(React__namespace.Children.only(this.props.children), this.containerElement)) : (null);
    }
}
...
class OverlayView extends React__namespace.PureComponent {
    ...
    render() {
        ...
        if (paneEl) {
            return ReactDOM__namespace.createPortal(jsxRuntime.exports.jsx("div", Object.assign({ ref: this.containerRef, style: this.state.containerStyle }, { children: React__namespace.Children.only(this.props.children) })), paneEl);
        }
        else {
            return null;
        }
...
class StandaloneSearchBox extends React.PureComponent {
    ...
    render() {
        return jsxRuntime.exports.jsx("div", Object.assign({ ref: this.containerElement }, { children: React.Children.only(this.props.children) }));
    }
}
...
class Autocomplete extends React.PureComponent {
    ...
    render() {
        return jsxRuntime.exports.jsx("div", Object.assign({ ref: this.containerElement, className: this.props.className || '' }, { children: React.Children.only(this.props.children) }));
    }
}
